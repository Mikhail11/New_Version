					...
					<div class="modal-content narrow-content">
						...
						<div class="modal-body">
							<div class="form-group">
								<label  for="phone">Введите&nbsp;номер&nbsp;телефона,<br>чтобы&nbsp;получить<abbr title="Присылаемое сообщение бесплатно. Оставляя нам номер телефона, Вы соглашаетесь с Политикой конфиденциальности." data-toggle="tooltip" data-placement="bottom">*</abbr> код&nbsp;для&nbsp;входа:</label>
